...
class Register extends React.Component {
  ...
  if(this.state.currentForm == 'start'){
    form = (
          <>
            <Text style={styles.whiteText}>myregulars is an app where bartenders can let their regulars know where they're working and what's going on at their bar.</Text>
      ...
      form = (
        <>
          <Text style={styles.whiteText}>Sharing your work schedule in myregulars will help you to build relationships with your regulars, pack your bar, and make more money!.</Text>
            <View style={styles.button} >
            <Button
              title="Next"
      ...
      form = (
        <>
          <Text style={styles.whiteText}>myregulars will show you who's working and the best places to go out.</Text>
            <View style={styles.button} >
            <Button
              title="Next"
              onPress={() => this.setState({ currentForm: 'register' })}
